...
pid_file=/var/run/cambottomCentre.omx.pid
screen -dmS $position sh -c "omxplayer --win '640 720 1280 1080' --live $(cat /home/pi/TPiCamMatrix/tCams.txt | grep -o 'bottomCentre.*' | cut -f2- -d'=')"
